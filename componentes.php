    ...
    <section class="container">
        ...
        <table>
            <tr>
                <td><article>
                <br>
                <h2>CPU é a sigla para Central Process Unit, ou Unidade Central de Processamento. Ele é o principal item de Hardware do computador, que também é conhecido como processador. A CPU é responsável por calcular e realizar tarefas determinadas pelo usuário e é considerado o cérebro do PC.
  ...
  >
        ...
        <table>
            <tr>
                <td><article>
                <br>
                <h2>O disco rígido é o dispositivo de armazenamento responsável por armazenar dados permanentes e temporários. Esses dados vêm de muitas formas diferentes, mas, a grosso modo, tudo é salvo ou instalado no computador: por exemplo, programas de computador, fotos da família, o sistema operacional, documentos de processamento de texto e muitos outros.
        ...
        <table>
            <tr>
                <td><article>
                <br>
                <h2> é um componente que armazena dados em computadores e consoles de videogame. Ele substitui o HDD (Hard Disk Drive) tradicional e ainda garante mais rapidez ao sistema, graças às velocidades maiores de leitura e gravação.
                </article>
                </td>
                <td>
                <div class="img6">
...
E não é só isso: as GPUs modernas cumprem um papel computacional mais amplo que não se limita a renderizar, o que as torna uma extensão da unidade de processamento central, ou CPU.
        ...
        <table>
            <tr>
                <td><article>
                <br>
                <h2> Uma unidade de alimentação, comumente abreviada como PSU, faz mais do que só fornecer energia para o computador. A energia de uma fonte de energia externa entra no sistema por meio dela e é alocada pela placa-mãe a componentes de hardware. Porém, nem todas as unidades, ou fontes de alimentação, são iguais, e sem uma PSU com a tensão certa, seu sistema não funciona.
